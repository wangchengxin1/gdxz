...
import pickerview.lib.WheelOptions;
...
public class OptionsPopupWindow extends PopupWindow implements OnClickListener {
	...
	private TextView tvEdtName;//设置Title
	...
	public OptionsPopupWindow(Context context) {
		...
		tvEdtName = (TextView)rootView.findViewById(R.id.tvEdtName);
	...
	public void setTitle(String code){
		if ("1".equals(code)) {
			tvEdtName.setText("请选择所属地");
		}else if("2".equals(code)){
			tvEdtName.setText("请选择民族");
		}else if("3".equals(code)){
			tvEdtName.setText("请选择所患疾病类型");
		}
	}
